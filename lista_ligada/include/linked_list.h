...
#define DECLARE_LINKED_LIST(TYPE) \
    ...
    bool list_##TYPE##_is_empty(const List_##TYPE*); \
    void list_##TYPE##_clear(List_##TYPE*); \
    void list_##TYPE##_print(const List_##TYPE*, void (*print_fn)(TYPE)); \
    bool list_##TYPE##_contains(const List_##TYPE*, TYPE); \
    bool list_##TYPE##_remove(List_##TYPE*, TYPE);
...
// ----------------------------
// Declaración para tipos concretos (puedes modificar según necesites)
// ----------------------------
